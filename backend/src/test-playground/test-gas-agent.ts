...
async function testGasAgent() {
  console.log("🧠 Testing GasOptimizerNeuron Agent...\n");
  ...
  const agent = new GasOptimizerNeuron(apiKey);
  ...
  console.log("💡 GasOptimizerNeuron Proposal:");
...
testGasAgent().catch(console.error);
