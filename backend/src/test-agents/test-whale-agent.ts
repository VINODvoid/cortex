...
async function testWhaleAgent() {
  console.log("🧠 Testing WhaleNeuron Agent...\n");
  ...
  const agent = new WhaleNeuron(apiKey);
  ...
  console.log("💡 WhaleNeuron Proposal:");
...
testWhaleAgent().catch(console.error);
