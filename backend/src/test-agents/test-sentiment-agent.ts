...
async function testSentimentAgent() {
  console.log("🧠 Testing SentimentNeuron Agent...\n");
  ...
  const agent = new SentimentNeuron(apiKey);
  ...
  console.log("💡 SentimentNeuron Proposal:");
...
testSentimentAgent().catch(console.error);
