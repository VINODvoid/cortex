...
async function testRebalancerAgent() {
  console.log("🧠 Testing RebalancerNeuron Agent...\n");
  ...
  const agent = new RebalancerNeuron(apiKey);
  ...
  console.log("💡 RebalancerNeuron Proposal:");
...
testRebalancerAgent().catch(console.error);
