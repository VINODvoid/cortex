...
async function testLiquidityAgent() {
  console.log("🧠 Testing LiquidityNeuron Agent...\n");
  ...
  const agent = new LiquidityNeuron(apiKey);
  ...
  console.log("💡 LiquidityNeuron Proposal:");
...
testLiquidityAgent().catch(console.error);
